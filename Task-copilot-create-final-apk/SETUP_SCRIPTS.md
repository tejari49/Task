...
1. FIREBASE_API_KEY → AIzaSyDMYgxeL...
2. FIREBASE_AUTH_DOMAIN → task-rai.firebaseapp.com
3. FIREBASE_PROJECT_ID → task-rai
4. FIREBASE_STORAGE_BUCKET → task-rai.firebasestorage.app
5. FIREBASE_MESSAGING_SENDER_ID → 99376901660
6. FIREBASE_APP_ID → 1:99376901660:android:...
7. FIREBASE_VAPID_KEY → BDJDq6q9JBjqsN...
```
