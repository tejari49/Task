...
2. Öffne `public/firebase-messaging-sw.js` und ersetze die Platzhalter (`VITE_FIREBASE_*`) durch dieselben Werte.
   - Hinweis: Ohne Ersetzung wird Firebase im Service Worker nicht initialisiert. Optional kannst du das über einen eigenen Build-Schritt automatisieren (standardmäßig gibt es keinen).
